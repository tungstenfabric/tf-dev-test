...
command juju run-action contrail-controller/leader upgrade-ziu
...
command juju config contrail-analytics image-tag=latest
command juju config contrail-analyticsdb image-tag=latest
command juju config contrail-agent image-tag=latest
command juju config contrail-openstack image-tag=latest
command juju config contrail-controller image-tag=latest
...
command juju run-action contrail-agent/0 upgrade
